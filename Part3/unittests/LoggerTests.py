...
class LoggerTest(unittest.TestCase):
    ...
    def test_02_train(self):
        ...
        update_train_log('test-tag',data_shape,eval_test, runtime,
                         model_version, model_version_note, test=True)

        df = pd.read_csv(log_file)
        logged_eval_test = [i for i in df['model_version_note'].copy()][-1]
        self.assertEqual(model_version_note, logged_eval_test)
    ...
    def test_03_predict(self):
        ...
        update_predict_log('united_states',y_pred, y_proba, 'target-date', runtime,
    ...
    def test_04_predict(self):
        ...
        model_version = 0.1
        query = ['united_states', 24, 'aavail_basic', 8]
        update_predict_log('united_states', y_pred, y_proba, query, runtime,
                           model_version, test=True)
